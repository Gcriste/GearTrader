										...
										<form>
											...
											<div className='row'>
												<div className='col-md-6'>
													<button
														type='submit'
														className='ui green horizontal animated button'
														tabindex='0'
												...
												<div className='col-md-6'>
													{/* <button className='ui purple horizontal animated button create-account'>
													...
													<Link to={'/createaccount'}>
														<button className='ui yellow horizontal animated button'>
															<div className='visible content'>Create Account</div>
															<div className='hidden content'>
																<i className='right arrow icon' />
															</div>
														</button>
